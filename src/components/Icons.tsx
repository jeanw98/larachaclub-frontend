...
export function IconHeatmap({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path d="M12 3c3 4 5 7 5 10a5 5 0 1 1-10 0c0-3 2-6 5-10z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconTrophy({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path d="M8 4h8v3a4 4 0 0 1-8 0V4zM6 4H4v1a3 3 0 0 0 3 3M18 4h2v1a3 3 0 0 1-3 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M12 11v3M9 20h6M10 14h4v3a2 2 0 0 1-4 0v-3z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconMap({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path d="M9 4l-5 2v14l5-2 6 2 5-2V4l-5 2-6-2z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
...
export function IconMoon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path d="M20 14.5A7.5 7.5 0 0 1 9.5 4 6 6 0 1 0 20 14.5z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconPinMap({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
